...
namespace CcmSdk.Net
{
    ...
    {
        [DllImport("CCMSDK", CharSet = CharSet.Unicode, ThrowOnUnmappableChar = true, BestFitMapping = false, EntryPoint = "CCMInitialize", CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        ...
        [DllImport("CCMSDK", CharSet = CharSet.Unicode, ThrowOnUnmappableChar = true, BestFitMapping = false, EntryPoint = "CCMLaunchPublishedApplication", CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        ...
        [DllImport("CCMSDK", CharSet = CharSet.Unicode, ThrowOnUnmappableChar = true, BestFitMapping = false, EntryPoint = "CCMDisconnectUserSessions", CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        ...
        [DllImport("CCMSDK", CharSet = CharSet.Unicode, ThrowOnUnmappableChar = true, BestFitMapping = false, EntryPoint = "CCMGetActiveSessionCountForUser", CallingConvention = CallingConvention.StdCall, SetLastError = true)]
